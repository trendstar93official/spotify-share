...
/*   const {Pool} = require(‘pg’);
  const pool = new Pool({
   connectionString: 'postgres://uqjhzyhrjxtzvk:237aee752d93fd1da2e5b42123ba58d708dbfadbe69e24f42de22465fd0866e2@ec2-54-158-190-214.compute-1.amazonaws.com:5432/d88bbjkgk00jbh',
   ssl: {
  ...
  const front_end_uri = process.env.APP_URL
  ...
  app.get('/callback', function(req, res) {
      ...
      if (state === null || state !== storedState) {
       ...
       /*  pool.query(`INSERT INTO Users(FirstName,LastName,accessToken)VALUES($1,$2)`, ['FirstNameValue','LastNameValue'], (err, res) => {
          if (err) {
